...
export const LESSONS: Lesson[] = [
  // ============ GRADE 3 · MATH ============
  {
    ...
    competencyTitle: "Add two 2-digit numbers without regrouping",
  ...
  },
  {
    ...
    competencyTitle: "Add 2-digit numbers with carrying (regrouping)",
  ...
  },
  {
    ...
    competencyTitle: "Subtract 2-digit numbers, including borrowing",
  ...
  },
  {
    ...
    competencyTitle: "Recall the 2\u00d7 multiplication table",
  ...
  },
  {
    ...
    competencyTitle: "Recall the 5\u00d7 multiplication table",
  ...
  },
  {
    ...
    competencyTitle: "Count and compute with Philippine peso amounts",
  ...
  },
  {
    ...
    competencyTitle: "Identify hundreds, tens, and ones in a number",
  ...
  },
  {
    ...
    competencyTitle: "Recognise halves and quarters as fractions",
  ...
  // ============ GRADE 4 · MATH ============
  {
    ...
    competencyTitle: "Recall the 3\u00d7 multiplication table",
  ...
  },
  {
    ...
    competencyTitle: "Recall the 4\u00d7 multiplication table",
  ...
  },
  {
    ...
    competencyTitle: "Recall the 6\u00d7 multiplication table",
  ...
  },
  {
    ...
    competencyTitle: "Add 3-digit numbers with regrouping",
  ...
  // ============ GRADE 5 · MATH ============
  {
    ...
    competencyTitle: "Add and compare decimals to tenths",
  ...
  },
  {
    ...
    competencyTitle: "Find area and perimeter of squares and rectangles",
  ...
  // ============ GRADE 3 · ENGLISH ============
  {
    ...
    competencyTitle: "Identify words with similar meanings (synonyms)",
  ...
  },
  {
    ...
    competencyTitle: "Identify opposite words (antonyms)",
  ...
  },
  {
    ...
    grade: 3,
    title: "Subject + verb",
    competencyTitle: "Find the subject and verb in a sentence",
  ...
  // ============ GRADE 4 · ENGLISH ============
  {
    ...
    competencyTitle: "Classify nouns, verbs, adjectives, and adverbs",
  ...
  },
  {
    ...
    competencyTitle: "Use past, present, and future verb tenses",
  ...
  // ============ GRADE 5 · ENGLISH ============
  {
    ...
    competencyTitle: "Answer comprehension questions about a short passage",
  ...
  },
  {
    ...
    competencyTitle: "Apply end marks, commas, and capitalisation",
  ...
  },
  {
    ...
    grade: 5,
    title: "Common idioms",
    competencyTitle: "Interpret common English idioms",
  ...
  // ============ GRADE 3 · FILIPINO ============
  {
    ...
    grade: 3,
    title: "Pangngalan",
    competencyTitle: "Tukuyin ang mga pangngalan (nouns)",
  ...
  },
  {
    ...
    grade: 3,
    title: "Pandiwa",
    competencyTitle: "Tukuyin ang mga pandiwa (verbs)",
  ...
  },
  {
    ...
    grade: 3,
    title: "Bokabularyo",
    competencyTitle: "Palawakin ang talasalitaan sa Filipino",
  ...
  // ============ GRADE 4 · FILIPINO ============
  {
    ...
    grade: 4,
    title: "Pangungusap",
    competencyTitle: "Buuin at unawain ang mga pangungusap",
  ...
  },
  {
    ...
    competencyTitle: "Pagbasa at pag-unawa sa maikling teksto",
  ...
  // ============ GRADE 5 · FILIPINO ============
  {
    ...
    competencyTitle: "Gamitin nang wasto ang mga pantukoy (ang, ng, sa, mga, si)",
  ...
  },
  {
    ...
    grade: 5,
    title: "Pang-uri",
    competencyTitle: "Tukuyin at gamitin ang mga pang-uri (adjectives)",
  ...
  },
  {
    ...
    grade: 5,
    title: "Sawikain",
    competencyTitle: "Unawain ang kahulugan ng mga sawikain (idioms)",
  ...
  // Friendly, image-light, repetition-heavy. Built for ages 6–8.
  {
    ...
    competencyTitle: "Count objects and numbers up to 10",
  ...
  },
  {
    ...
    competencyTitle: "Add small numbers within 10",
  ...
  },
  {
    ...
    competencyTitle: "Add numbers within 20",
  ...
  },
  {
    ...
    competencyTitle: "Recognise the letters of the alphabet",
  ...
  },
  {
    ...
    grade: 2,
    title: "Sight words",
    competencyTitle: "Read common sight words on sight",
  ...
  },
  {
    ...
    grade: 1,
    title: "Mga Titik",
    competencyTitle: "Kilalanin ang mga titik ng alpabeto",
  ...
  },
  {
    ...
    competencyTitle: "Pagbasa ng simpleng pangungusap",
  ...
  // ============ GRADE 6–7 · JUNIOR LEARNERS ============
  {
    ...
    grade: 6,
    title: "Long division",
    competencyTitle: "Divide multi-digit numbers using long division",
  ...
  },
  {
    ...
    competencyTitle: "Calculate basic percentages of a number",
  ...
  },
  {
    ...
    competencyTitle: "Set up and solve ratios and proportions",
  ...
  },
  {
    ...
    competencyTitle: "Build vocabulary through context clues",
  ...
  },
  {
    ...
    competencyTitle: "Organise an essay: intro, body, conclusion",
  ...
  // ============ GRADE 8–10 · TEEN LEARNERS ============
  {
    ...
    competencyTitle: "Solve one-step equations for an unknown (x)",
  ...
  },
  {
    ...
    competencyTitle: "Measure angles and classify triangles",
  ...
  },
  {
    ...
    competencyTitle: "Apply the Pythagorean theorem to right triangles",
  ...
  },
  {
    ...
    competencyTitle: "Interpret similes, metaphors, and other figurative language",
  ...
  },
  {
    ...
    competencyTitle: "Cite sources and evaluate research credibility",
  ...
  // ============ SCIENCE — across grades ============
  {
    ...
    competencyTitle: "Distinguish living from non-living things",
  ...
  },
  {
    ...
    competencyTitle: "Explain the stages of the water cycle",
  ...
  },
  {
    ...
    competencyTitle: "Describe how plants make food through photosynthesis",
  ...
  },
  {
    ...
    competencyTitle: "Identify the basic parts and roles of a cell",
  ...
  },
  {
    ...
    competencyTitle: "Apply Newton's three laws of motion",
  ...
  // ============ ARALING PANLIPUNAN — across grades ============
  {
    ...
    competencyTitle: "Kilalanin ang Pilipinas bilang sariling bansa",
  ...
  },
  {
    ...
    competencyTitle: "Alamin ang mga bayani ng Pilipinas at ambag nila",
  ...
  },
  {
    ...
    competencyTitle: "Tukuyin ang mga bansa at kultura sa Asya",
  ...
  },
  {
    ...
    competencyTitle: "Unawain ang supply at demand sa ekonomiya",
