...
export const CAREERS: Career[] = [
  ...
  // ============ EXPANDED TECH ROLES ============
  {
    ...
    category: "STEM",
    rarity: "legendary",
    oneLiner: "Builds the artificial intelligence behind chatbots, self-driving cars, and ForgeBot.",
    whatTheyDo: [
      "Train AI models on huge amounts of data",
      "Teach computers to recognize images, voices, and text",
      "Tune ChatGPT-like systems to be smarter and safer",
      "Push the limits of what machines can do",
    ],
    funFact: "Filipinos work at OpenAI, Google DeepMind, and Anthropic right now — building tomorrow's AI.",
    gradient: "from-fuchsia-400 to-violet-600",
    accentColor: "#a855f7",
    helpfulSubjects: ["math", "science"],
    xpToUnlock: 1800,
    pathToBecome: "CompSci/Math degree → Masters in AI/ML → Research or top tech company.",
    collegeTrack: "STEM",
    phContext: "PH AI talent grows fast — DOST AI Pilipinas, UP AI Lab, plus remote AI roles globally.",
  },
  {
    id: "data-scientist",
    ...
    category: "STEM",
    rarity: "rare",
    oneLiner: "Finds hidden stories and answers inside huge piles of data.",
    whatTheyDo: [
      "Analyze data to spot patterns and trends",
      "Build models that predict what will happen next",
      "Help businesses make smarter decisions",
      "Turn numbers into clear insights with charts",
    ],
    funFact: "Netflix uses data scientists to decide which shows to make — your watch history shaped Squid Game.",
    gradient: "from-cyan-400 to-blue-600",
    accentColor: "#06b6d4",
    helpfulSubjects: ["math", "science"],
    xpToUnlock: 1000,
    pathToBecome: "Stats/CompSci degree → Python + SQL skills → Junior analyst → Senior data scientist.",
    collegeTrack: "STEM",
    phContext: "Hiring like crazy: Globe, GCash, Maya, Shopee PH, Grab PH.",
  },
  {
    id: "cybersecurity",
    ...
    category: "STEM",
    rarity: "rare",
    oneLiner: "Defends companies and people from hackers.",
    whatTheyDo: [
      "Find security holes before bad guys do",
      "Investigate hacks and stop them in real time",
      "Set up firewalls, encryption, and defenses",
      "Train others to spot phishing and scams",
    ],
    funFact: "Ethical 'white-hat' hackers are paid to break in legally — bounties can reach ₱5M+ per bug.",
    gradient: "from-emerald-400 to-cyan-600",
    accentColor: "#10b981",
    helpfulSubjects: ["math", "english"],
    xpToUnlock: 1100,
    pathToBecome: "IT/CompSci degree → Security certs (CEH, OSCP) → SOC analyst → Security engineer.",
    collegeTrack: "STEM",
    phContext: "Big demand at BPI, BDO, Maya, government (DICT), and global remote work.",
  },
  {
    id: "mobile-dev",
    ...
    category: "STEM",
    rarity: "uncommon",
    oneLiner: "Builds the iOS and Android apps you use every day.",
    whatTheyDo: [
      "Design app screens and interactions",
      "Write code that runs on iPhones and Androids",
      "Fix bugs and ship updates",
      "Make apps fast, beautiful, and easy to use",
    ],
    funFact: "GCash, Maya, and Mynt are all built by Filipino mobile devs — used by 80M+ Filipinos.",
    gradient: "from-sky-400 to-indigo-500",
    accentColor: "#0ea5e9",
    helpfulSubjects: ["math", "english"],
    xpToUnlock: 700,
    pathToBecome: "CompSci/IT degree → Swift (iOS) or Kotlin (Android) skills → Junior dev → Senior.",
    collegeTrack: "STEM",
    phContext: "Top mobile employers in PH: Mynt, Coins.ph, PayMongo, Kumu, Sprout.",
  },
  {
    id: "ux-designer",
    title: "UX Designer",
    ...
    category: "Creative",
    rarity: "rare",
    oneLiner: "Designs apps and websites that feel natural and easy to use.",
    whatTheyDo: [
      "Watch how people use products and find friction",
      "Sketch and prototype better experiences",
      "Test designs with real users",
      "Work with engineers to ship pixel-perfect products",
    ],
    funFact: "Great UX is invisible — when you use an app without thinking, that's a UX designer doing their job perfectly.",
    gradient: "from-pink-400 to-fuchsia-500",
    accentColor: "#ec4899",
    helpfulSubjects: ["english", "araling-panlipunan"],
    xpToUnlock: 900,
    pathToBecome: "Design / HCI / IT degree → Build portfolio in Figma → Junior designer → Senior.",
    collegeTrack: "STEM or HUMSS",
    phContext: "Hiring: Mynt, Kumu, PayMongo, Coins.ph, plus tons of remote roles at US/EU companies.",
  },
  {
    id: "devops",
    ...
    category: "STEM",
    rarity: "rare",
    oneLiner: "Makes sure apps stay online — runs the engine rooms of the internet.",
    whatTheyDo: [
      "Set up cloud servers (AWS, GCP, Azure)",
      "Automate deployments so updates ship in seconds",
      "Monitor systems and respond to outages",
      "Keep millions of users' apps running 24/7",
    ],
    funFact: "Netflix, Spotify, and Discord all run on cloud platforms managed by DevOps engineers.",
    gradient: "from-slate-400 to-blue-600",
    accentColor: "#3b82f6",
    helpfulSubjects: ["math", "english"],
    xpToUnlock: 1300,
    pathToBecome: "IT/CompSci degree → Linux + cloud certs (AWS, Kubernetes) → Junior → Senior DevOps.",
    collegeTrack: "STEM",
    phContext: "High pay, often remote. PH DevOps earn ₱60K–₱200K+ /month depending on level.",
  },
  {
    id: "robotics",
    ...
    category: "STEM",
    rarity: "legendary",
    oneLiner: "Builds real robots — from factory arms to delivery bots to humanoid androids.",
    whatTheyDo: [
      "Design how robots move, sense, and react",
      "Write code that controls motors and sensors",
      "Combine mechanical, electrical, and software skills",
      "Build things that didn't exist before",
    ],
    funFact: "Filipino-built robots have competed in international VEX Robotics championships and won.",
    gradient: "from-orange-400 to-rose-600",
    accentColor: "#f97316",
    helpfulSubjects: ["math", "science"],
    xpToUnlock: 1700,
    pathToBecome: "Mechanical/Electrical/CompSci Engineering → Specialize in robotics → Research or industry.",
    collegeTrack: "STEM",
    phContext: "PH has growing robotics teams at DOST, UP, DLSU. Boston Dynamics & Tesla hire globally.",
  },
  {
    id: "cloud-architect",
    ...
    category: "STEM",
    rarity: "legendary",
    oneLiner: "Designs how giant systems run in the cloud — for apps used by millions.",
    whatTheyDo: [
      "Plan how systems scale to handle huge traffic",
      "Choose between AWS, Google Cloud, or Azure",
      "Save companies millions on infrastructure",
      "Lead architecture decisions across teams",
    ],
    funFact: "Senior cloud architects in PH/remote can earn ₱200K–₱500K/month — among the highest tech salaries.",
    gradient: "from-cyan-400 to-blue-700",
    accentColor: "#0891b2",
    helpfulSubjects: ["math", "english"],
    xpToUnlock: 2200,
    pathToBecome: "CompSci/IT degree → 5+ years DevOps experience → Cloud certs (AWS Solutions Architect).",
    collegeTrack: "STEM",
    phContext: "Globe, BPI, big banks, and global remote roles all hire cloud architects.",
  },
  {
    id: "game-developer",
    ...
    category: "STEM",
    rarity: "rare",
    oneLiner: "Codes the games — the engine, the physics, the combat, the chaos.",
    whatTheyDo: [
      "Write the code that makes games actually work",
      "Build physics, animations, and combat systems",
      "Optimize so games run smoothly on every device",
      "Ship updates and fix bugs",
    ],
    funFact: "Filipino game devs work on Mobile Legends, Roblox, and indie hits — and the PH game industry is booming.",
    gradient: "from-violet-500 to-purple-700",
    accentColor: "#7c3aed",
    helpfulSubjects: ["math", "english"],
    xpToUnlock: 1100,
    pathToBecome: "CompSci or Game Dev degree → Unity/Unreal skills → Junior gameplay dev → Senior.",
    collegeTrack: "STEM",
    phContext: "PH studios: Synergy88, Boomzap, Altitude Games, Kooapps. Or remote at Riot, Roblox, Epic.",
  },
  {
    id: "vr-ar",
    ...
    category: "STEM",
    rarity: "rare",
    oneLiner: "Builds virtual and augmented reality worlds — the future of computing.",
    whatTheyDo: [
      "Code VR games and AR filters",
      "Design immersive 3D experiences",
      "Make virtual worlds feel real",
      "Pioneer the next big platform after phones",
    ],
    funFact: "Apple Vision Pro, Meta Quest, and Snapchat filters are all built by VR/AR devs — a job that barely existed 10 years ago.",
    gradient: "from-indigo-400 to-fuchsia-600",
    accentColor: "#8b5cf6",
    helpfulSubjects: ["math", "science"],
    xpToUnlock: 1500,
    pathToBecome: "Game Dev/CompSci → Unity 3D + C# → Build portfolio of VR/AR projects.",
    collegeTrack: "STEM",
    phContext: "Emerging field in PH — early movers get noticed. Remote roles at Meta, Snap, Niantic.",
  },
  {
    id: "blockchain",
    ...
    category: "STEM",
    rarity: "rare",
    oneLiner: "Builds crypto wallets, DeFi apps, and the rails of Web3.",
    whatTheyDo: [
      "Write smart contracts (Solidity, Rust)",
      "Build crypto wallets and exchanges",
      "Make decentralized apps (dApps)",
      "Work at the edge of finance and tech",
    ],
    funFact: "Filipinos played huge in Axie Infinity — the country was one of the top 'play-to-earn' nations in the world.",
    gradient: "from-amber-400 to-yellow-600",
    accentColor: "#eab308",
    helpfulSubjects: ["math", "english"],
    xpToUnlock: 1400,
    pathToBecome: "CompSci → learn Solidity (Ethereum) or Rust (Solana) → Junior blockchain dev.",
    collegeTrack: "STEM",
