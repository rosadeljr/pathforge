...
const SLIDES = [
  ...
  {
    title: "Need guidance?",
    subtitle: "Your AI mentor knows you.",
    description:
      "Stuck? Confused? Wondering what to learn next? Your mentor sees your level, goals, and progress — and answers like a friend who's been there.",
    icon: Bot,
    accent: "#ec4899",
