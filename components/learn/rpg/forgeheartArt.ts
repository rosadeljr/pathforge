...
function chibi(x: number, y: number, look: { accent: string; item?: string; hat?: string; acc?: string; skin?: string; hair?: string }, width: number, flip = false) {
  const a = look.accent, item = look.item || "none", hat = look.hat || "none", acc = look.acc || "none"; const sk = look.skin || "#f7d6b3", hr = look.hair || "#3b2a1a", t = "#fcd34d", ol = "#16202e"; const sc = width / 56, tx = x - 28 * sc, ty = y - 64 * sc; const noFace = hat === "glasses";
  ...
  return `<g transform="translate(${tx},${ty}) scale(${sc}) ${flip ? `translate(56,0) scale(-1,1)` : ""}"><ellipse cx="28" cy="61" rx="14" ry="3.6" fill="#000" opacity="0.3"/><ellipse cx="28" cy="60" rx="11" ry="2.6" fill="${a}" opacity="0.5"/><rect x="23.5" y="50" width="4" height="9" rx="2" fill="#27324a"/><rect x="28.5" y="50" width="4" height="9" rx="2" fill="#27324a"/><rect x="23.5" y="57.5" width="4" height="1.6" fill="#67e8f9" opacity="0.8"/><rect x="28.5" y="57.5" width="4" height="1.6" fill="#67e8f9" opacity="0.8"/><ellipse cx="25.5" cy="59.5" rx="3.2" ry="1.8" fill="#0f172a"/><ellipse cx="30.5" cy="59.5" rx="3.2" ry="1.8" fill="#0f172a"/><path d="M19 40 Q28 36 37 40 L35.5 52.5 Q28 55.5 20.5 52.5 Z" fill="${a}" stroke="${ol}" stroke-width="0.7"/><path d="M19 40 Q28 36 37 40 L36 46 Q28 49 20 46 Z" fill="#fff" opacity="0.14"/><rect x="20.5" y="48.5" width="15" height="2.6" rx="1.3" fill="#1a2230"/><line x1="28" y1="40.5" x2="28" y2="48" stroke="#bdf3fc" stroke-width="0.8" opacity="0.85"/><circle cx="28" cy="49.8" r="3" fill="#bdf3fc" opacity="0.3"/><circle cx="28" cy="49.8" r="1.5" fill="#bdf3fc"/><path d="M24.5 39.5 L28 43.5 L31.5 39.5" fill="none" stroke="${t}" stroke-width="1.4" stroke-linecap="round"/><path d="M18.5 40 q-2.6 5 -1 9.5 l2.6 -0.8 q-1 -4.5 0.8 -7.7 z" fill="${a}" stroke="${ol}" stroke-width="0.6"/><path d="M37.5 40 q2.6 5 1 9.5 l-2.6 -0.8 q1 -4.5 -0.8 -7.7 z" fill="${a}" stroke="${ol}" stroke-width="0.6"/><rect x="17.2" y="47.4" width="3" height="1.5" rx="0.7" fill="#67e8f9" opacity="0.85"/><rect x="35.8" y="47.4" width="3" height="1.5" rx="0.7" fill="#67e8f9" opacity="0.85"/><circle cx="39" cy="46" r="2.4" fill="${sk}"/>${shield}${itemVec(item)}<circle cx="28" cy="24" r="15.5" fill="${sk}" stroke="${ol}" stroke-width="0.8"/><path d="M12.5 24 Q12 8 28 7 Q44 8 43.5 24 Q41 15 33 14 Q28 10.5 23 14 Q15 15 12.5 24 Z" fill="${hr}" stroke="${ol}" stroke-width="0.7"/>${hatVec(hat, a)}${noFace ? "" : `<ellipse cx="22.5" cy="26" rx="2.8" ry="3.4" fill="#fff"/><ellipse cx="34" cy="26" rx="2.8" ry="3.4" fill="#fff"/><circle cx="23" cy="26.7" r="1.8" fill="#1f2937"/><circle cx="34.4" cy="26.7" r="1.8" fill="#1f2937"/><circle cx="22.3" cy="25.6" r="0.7" fill="#fff"/><circle cx="33.7" cy="25.6" r="0.7" fill="#fff"/><circle cx="19.5" cy="30" r="2" fill="#fb7185" opacity="0.4"/><circle cx="37" cy="30" r="2" fill="#fb7185" opacity="0.4"/><path d="M24.5 31 Q28 33.6 31.5 31" fill="none" stroke="#9a5b3b" stroke-width="1.2" stroke-linecap="round"/>`}</g>`;
}
