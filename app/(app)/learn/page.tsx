...
/**
 * /learn — Forgeheart City as a 2D top-down explorable world. Walk your hero
 * around and step into buildings/portals to launch quests, classes, the arena,
 * and subject realms. The HUD + section nav stay overlaid for quick access.
 */
